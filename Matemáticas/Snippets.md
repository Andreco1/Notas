[
	...
	{trigger: "lagra", replacement: "\\mathcal{L}\\{ $0 \\}", options: "mA"},
	...
	{trigger: "plt", replacement:  "\`\`\`tikz\n\\begin{document}\n\\begin{tikzpicture}[domain=$0:$1]\n$2\n\\end{tikzpicture}\n\\end{document}\n\`\`\`", options: "tA"},

	{trigger:"line", replacement: "\\draw[-, color=$0] ($1,$2) -- ($3,$4) node[$5]{$6};", options: "cA"},

	{trigger:"pl3d2", replacement: "\`\`\`tikz\n\\begin{document}\n\\begin{tikzpicture}[domain=-1:1]\n\\draw[->, color=black] (0,0) -- (0,1) node[anchor=west]{$z$};\n\\draw[->, color=black] (0,0) -- (1,0) node[anchor=west]{$y$};\n\\draw[->, color=black] (0,0) -- (-0.5,-0.7) node[right]{$x$};\n\\end{tikzpicture}\n\\end{document}\n\`\`\`", options:"tA"},

	{trigger:"pto", replacement: "\\draw[black, fill] ($0,$1) circle(2pt) node[$2]{$3};", options: "cA"},

	{trigger: "scr", replacement: "\\mathscr{$0} ", options: "mA"},

	{trigger:"vec", replacement:"\\draw[->, color=black] ($0,$1) -- ($3,$4) node[$5]{$6};", options:"cA"},

	{trigger:"lap", replacement: "\\mathcal{L}_{L}\\{f(z)\\}=", options: "mA"},
